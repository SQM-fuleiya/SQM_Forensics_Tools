...
if __name__ == '__main__':
    ...
    #bb=b"pass=DlMRWA1cL1gOVDc2MjRhRwZFEQ%3D%3D"
    #decrypter = PHP_XOR_BASE64(pass_='pass', key='3c6e0b8a9c15224a')
    #data = decrypter.decrypt_req_payload(bb)
    #print(data.decode('utf-8','ignore'))
    #aa=b"11cd6a8758984163fL1tMGI4YTljMr74n/zpAU0Y6vrv8uz17vvFRXv9kDhqG5JHqw6VMpSdxz17ApQ4EgKRRZPy7/UR+7nAAoRkM/yduAZWOGE56c37ac826a2a04bc"
    #data = decrypter.decrypt_res_payload(aa)
    #print(data.decode())
    ...
    decrypter = JAVA_AES_RAW(pass_='pass', key='748007e861908c03')

    java_raw_req ='''36d6513e77d49f26df4e661179a6da648b1a0cc00f32777a2e91d86e1ebce786e4a083acbad4e59b2e71d479f982f96a99929eec9a28cd9a82ec20199829c0d8'''
